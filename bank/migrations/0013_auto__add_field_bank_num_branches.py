...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bank.num_branches'
        db.add_column('bank_bank', 'num_branches', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Bank.num_branches'
        db.delete_column('bank_bank', 'num_branches')
