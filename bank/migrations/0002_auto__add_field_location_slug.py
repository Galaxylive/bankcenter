...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('bank_location', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=200, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.slug'
        db.delete_column('bank_location', 'slug')
